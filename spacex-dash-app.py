...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        fig= px.pie(filtered_df, values='class', names='Launch Site', title='Total Success Launces By All Sites')
        return fig
    else:
        fig = px.pie(spacex_df[spacex_df["Launch Site"]==entered_site], names = 'class', title = 'Launch status')
        return fig
...
def get_scatter_slider_chart(entered_site, payload_slider):
    ...
    if entered_site == 'ALL':
        ...
        y = 'class',
        color = 'Booster Version Category',
        title = 'Correlation Between Payload And Mission Outcomes')
        return fig
# Run the app
